...
public class ParkInfoSql {
	...
	private static String PARK_FIELD = "pid, createtime, updatetime, pname, recid, devid, address, lat, lng, ispub";
	private static String PARK_PARAMS = ":pid, :createTime, :updateTime, :pName, :recId, :devId, :address, :lat, :lng, :isPub";
	...
	public static String FIND_PARK_BYID = "SELECT " + PARK_FIELD + " FROM " + TBL_NAME + "WHERE pid=? and ispub=1";
